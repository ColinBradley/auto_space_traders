...
pub async fn accept_contract(
    ...
    contract_id: &str,
) -> Result<crate::models::AcceptContract200Response, Error<AcceptContractError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceptContractError> =
...
pub async fn deliver_contract(
...
) -> Result<crate::models::DeliverContract200Response, Error<DeliverContractError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeliverContractError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fulfill_contract(
    configuration: &configuration::Configuration,
    contract_id: &str,
) -> Result<crate::models::FulfillContract200Response, Error<FulfillContractError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FulfillContractError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_contract(
    configuration: &configuration::Configuration,
    contract_id: &str,
) -> Result<crate::models::GetContract200Response, Error<GetContractError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contracts(
    ...
    page: Option<u32>,
    limit: Option<u32>,
) -> Result<crate::models::GetContracts200Response, Error<GetContractsError>> {
    let local_var_configuration = configuration;
