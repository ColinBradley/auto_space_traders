...
pub async fn create_chart(
    ...
    ship_symbol: &str,
) -> Result<crate::models::CreateChart201Response, Error<CreateChartError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateChartError> =
...
pub async fn create_ship_ship_scan(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::CreateShipShipScan201Response, Error<CreateShipShipScanError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateShipShipScanError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_ship_system_scan(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::CreateShipSystemScan201Response, Error<CreateShipSystemScanError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateShipSystemScanError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_ship_waypoint_scan(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::CreateShipWaypointScan201Response, Error<CreateShipWaypointScanError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateShipWaypointScanError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_survey(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::CreateSurvey201Response, Error<CreateSurveyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSurveyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dock_ship(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::DockShip200Response, Error<DockShipError>> {
    let local_var_configuration = configuration;
...
pub async fn extract_resources(
...
) -> Result<crate::models::ExtractResources201Response, Error<ExtractResourcesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtractResourcesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn extract_resources_with_survey(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
    survey: Option<crate::models::Survey>,
) -> Result<crate::models::ExtractResources201Response, Error<ExtractResourcesWithSurveyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExtractResourcesWithSurveyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_mounts(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::GetMounts200Response, Error<GetMountsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMountsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_my_ship(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::GetMyShip200Response, Error<GetMyShipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMyShipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_my_ship_cargo(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::GetMyShipCargo200Response, Error<GetMyShipCargoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMyShipCargoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_my_ships(
    ...
    page: Option<u32>,
    limit: Option<u32>,
) -> Result<crate::models::GetMyShips200Response, Error<GetMyShipsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMyShipsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_ship_cooldown(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::GetShipCooldown200Response, Error<GetShipCooldownError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetShipCooldownError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_ship_nav(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::GetShipNav200Response, Error<GetShipNavError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetShipNavError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn install_mount(
...
) -> Result<crate::models::InstallMount201Response, Error<InstallMountError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<InstallMountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::Jettison200Response, Error<JettisonError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::JumpShip200Response, Error<JumpShipError>> {
    let local_var_configuration = configuration;
...
pub async fn navigate_ship(
...
) -> Result<crate::models::NavigateShip200Response, Error<NavigateShipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NavigateShipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn negotiate_contract(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::NegotiateContract200Response, Error<NegotiateContractError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NegotiateContractError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orbit_ship(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::OrbitShip200Response, Error<OrbitShipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrbitShipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_ship_nav(
...
) -> Result<crate::models::GetShipNav200Response, Error<PatchShipNavError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchShipNavError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn purchase_cargo(
...
) -> Result<crate::models::PurchaseCargo201Response, Error<PurchaseCargoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PurchaseCargoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn purchase_ship(
...
) -> Result<crate::models::PurchaseShip201Response, Error<PurchaseShipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PurchaseShipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn refuel_ship(
...
) -> Result<crate::models::RefuelShip200Response, Error<RefuelShipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RefuelShipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_mount(
...
) -> Result<crate::models::RemoveMount201Response, Error<RemoveMountError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveMountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sell_cargo(
...
) -> Result<crate::models::SellCargo201Response, Error<SellCargoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SellCargoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn ship_refine(
...
) -> Result<crate::models::ShipRefine201Response, Error<ShipRefineError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ShipRefineError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn siphon_resources(
    configuration: &configuration::Configuration,
    ship_symbol: &str,
) -> Result<crate::models::SiphonResources201Response, Error<SiphonResourcesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SiphonResourcesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn transfer_cargo(
...
) -> Result<crate::models::TransferCargo200Response, Error<TransferCargoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TransferCargoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn warp_ship(
    ...
    ship_symbol: &str,
    navigate_ship_request: Option<crate::models::NavigateShipRequest>,
) -> Result<crate::models::NavigateShip200Response, Error<WarpShipError>> {
    let local_var_configuration = configuration;
