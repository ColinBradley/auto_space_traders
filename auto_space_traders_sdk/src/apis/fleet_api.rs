...
pub async fn get_my_ships(configuration: &configuration::Configuration, page: Option<u32>, limit: Option<u32>) -> Result<crate::models::GetMyShips200Response, Error<GetMyShipsError>> {
    let local_var_configuration = configuration;
