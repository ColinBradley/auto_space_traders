...
pub async fn get_faction(
    ...
    faction_symbol: &str,
) -> Result<crate::models::GetFaction200Response, Error<GetFactionError>> {
    ...
    let local_var_uri_str = format!(
        ...
        factionSymbol = crate::apis::urlencode(faction_symbol)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFactionError> =
...
pub async fn get_factions(
    ...
    page: Option<u32>,
    limit: Option<u32>,
) -> Result<crate::models::GetFactions200Response, Error<GetFactionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
