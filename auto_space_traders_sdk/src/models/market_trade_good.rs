...
impl MarketTradeGood {
    pub fn new(symbol: crate::models::TradeSymbol, r#type: Type, trade_volume: u32, supply: crate::models::SupplyLevel, purchase_price: u32, sell_price: u32) -> MarketTradeGood {
        MarketTradeGood {
            symbol,
            r#type,
            trade_volume,
